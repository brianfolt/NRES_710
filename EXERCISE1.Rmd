...
If you are new to R or would like a refresher, some university faculty held an R workshop last spring last spring. The material is all hosted [here](https://kevintshoemaker.github.io/R-Bootcamp/). You can work through the modules at your own pace:
...
When you're ready, follow the instructions below and write four functions. Apply them and testing them as indicated. 
