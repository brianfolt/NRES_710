...
```{r no-violations-1, echo=FALSE, message=FALSE, warning=FALSE, fig.width=4.5, fig.height=4.5}
# Set the seed for reproducibility
set.seed(123)
...
- Click [here](lecture_6_code.R) to download code. This is general code to help make these graphs.

- Click on these links to download and save the data: [good data](lecture_6_good_data.csv), [nonlinear data](lecture_6_nonlinear_data.csv), [nonnormal data](lecture_6_nonnormal_data.csv), [heteroscedastic data](lecture_6_heteroscedastic_data.csv), and [autocorrelated data](lecture_6_autocorrelated_data.csv).
...
```{r no-violations_1, echo=TRUE, message=FALSE, warning=FALSE, fig.width=4.5, fig.height=4.5}
# Load the data
