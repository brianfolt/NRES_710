...
datum <- read.csv("lecture_14_dataset2.csv")
...
datum <- read.csv("lecture_14_dataset3.csv")
...
# Read in size ~ elevation + latitude
datum <- read.csv("lecture_14_dataset4.csv")
...
# These data were saved as 'lecture_14_dataset5.csv'
...
# Load the data
datum <- read.csv("lecture_14_dataset5.csv")
head(datum)
...
# Save the data
write.csv(datum, "lecture_14_dataset2.csv", row.names = FALSE)
...
# Save the CSV file
write.csv(datum, "lecture_14_dataset3.csv")
...
# Save the CSV file
write.csv(datum, "lecture_14_dataset4.csv", row.names = FALSE)
...
# Save as CSV
write.csv(datum, "lecture_14_dataset5.csv")
```
