...
What if we no longer have a continuous X-variable, but instead have a categorical variable?
...
For example, let's say we are interested in testing for body size differences between two sexes of **elephant seal** (*Mirounga angustirostris*).
