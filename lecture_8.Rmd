...
```{r predict_4, echo=TRUE, message=FALSE, warning=FALSE, fig.width=4.5, fig.height=3.5}
# Create predict data
...
```{r predict_5, echo=TRUE, message=FALSE, warning=FALSE, fig.width=4.5, fig.height=3.5}
predictions[1,"upr"] - predictions[1,"fit"]
```

The 95% prediction interval is +/-10.51.
...
```{r predict_6, echo=TRUE, message=FALSE, warning=FALSE, fig.width=4.5, fig.height=3.5}
# Examine summary
summary(datum)
...
```{r predict_7, echo=TRUE, message=FALSE, warning=FALSE, fig.width=4.5, fig.height=3.5}
...
```{r predict_8, echo=TRUE, message=FALSE, warning=FALSE, fig.width=4.5, fig.height=4.5}
...
```{r predict_9, echo=TRUE, message=FALSE, warning=FALSE, fig.width=4.5, fig.height=4.5}
