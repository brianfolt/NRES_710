---
title: "Exercise 6: Multivariable Analysis and Interactions"
author: "NRES 710"
...
**[Dataset 2](exercise_6_dataset2.csv)** -- For this dataset, you have two categorical factors (e.g., Sex and Treatment) and each factor has two levels [male + female, control (placebo) + hormone injection]. The dependent variable is adult body size. In this system, there is an interaction between sex and treatment.
...
**[Dataset 3](exercise_6_dataset3.csv)** -- For this dataset, you have two continuous variables (e.g., Elevation - meters asl; and Latitude - km). The dependent variable is Red-backed Salamander (*Plethodon cinereus*) body size (g). In this system, there is an interaction between elevation and latitude.
...
# Save the CSV file
write.csv(datum, "exercise_6_dataset1.csv")
...
# Save the CSV file
write.csv(datum, "exercise_6_dataset2.csv")
