...
Office: Knudsten Resource Center, Room 100, Office A<br>
Phone: TBD<br>
Email: [bfolt@unr.edu](bfolt@unr.edu)

I have no pre-scheduled office hours for this class; instead, please email me to set up a meeting. In general, I will be in my office during working hours from 8:30AM--5PM and can be available to discuss course material.
...
rmarkdown::render('syllabus.Rmd', 'word_document')
rmarkdown::render('schedule.Rmd', 'word_document')

knitr::opts_chunk$set(echo = TRUE, message = FALSE)
rmarkdown::render('syllabus.Rmd', rmarkdown::pdf_document())
