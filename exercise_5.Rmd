...
Bonus: Note that the squirrel density is higher in pine at low road density and lower in pine at high road density. At approximately what road density is squirrel density the same between both forest types? Show a graph illustrating how you found that solution.

<br>

## Problem 2

**[Dataset 2](exercise_5_dataset2.csv)** -- For this dataset, you have two categorical factors (e.g., Sex and Treatment) and each factor has two levels [male + female, control (placebo) + hormone injection]. The dependent variable is adult body size (kg). In this system, there is an interaction between sex and treatment.
