...
**[Dataset 3](exercise_2_dataset3.csv)** -- the relationship between prey density (X; prey/ha) and black bear litter size (Y; pups); Note: litter size is not continuous, but that's not the assumption that has been violated.
