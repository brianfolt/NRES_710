...
```{r dataset_1, echo=FALSE, message=FALSE, warning=FALSE}
...
[Dataset](exercise2_dataset2.csv)
...
```{r dataset_2, echo=FALSE, message=FALSE, warning=FALSE}
# Set the seed for reproducibility
set.seed(123)
...
[Dataset](exercise2_dataset3.csv)
...
```{r dataset_3, echo=FALSE, message=FALSE, warning=FALSE}
# Set the seed for reproducibility
set.seed(123)
...
If you would like to know the values used to create these datasets (i.e., 'truth'), download and examine this [R script](exercise_2_code.R).
