...
Compile all of your results in a document. Load this into the WebCampus assignment portal and submit it by the due date indicated in the course schedule.
...
For the final problem, describe the relationship between X and Y using the standard statements, but also use prediction to report what the expected number of livestock killed by wolves is at 20.0 deer/ha with prediction intervals. Finally, generate a graph of the y predictions and the prediction intervals (e.g., as we did in class).
