...
```{r seasons-3, echo=TRUE, message=FALSE, warning=FALSE}
# Fit a linear model
...
```{r seasons-4, echo=TRUE, message=FALSE, warning=FALSE}
# Help file
help(TukeyHSD)
...
```{r seasons-5, echo=TRUE, message=FALSE, warning=FALSE}
summary(results)
```
...
```{r seasons-6, echo=TRUE, message=FALSE, warning=FALSE}
TukeyHSD(results3)
confint(results)
```
...
```{r seasons-7, echo=TRUE, message=FALSE, warning=FALSE}
# Spring to Fall
...
```{r seasons-8, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r seasons-9, echo=TRUE, message=FALSE, warning=FALSE}
# Run a 'lm()' with that
...
```{r seasons-10, echo=TRUE, message=FALSE, warning=FALSE}
# Scatterplot
...
```{r seasons-11, echo=TRUE, message=FALSE, warning=FALSE}
# Scatterplot
