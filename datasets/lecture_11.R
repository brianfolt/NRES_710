...
########################### 'Truth' ############################# 
### Lecture 11: code to simulate data for multi-variable analysis
...
# Save the data
write.csv(datum, "../datasets/lecture_11_dataset1.csv", row.names = FALSE)
...
# Save the data
write.csv(datum, "../datasets/lecture_11_dataset2.csv", row.names = FALSE)
