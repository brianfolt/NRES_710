...
# Save the CSV file
write.csv(datum, "../datasets/lecture_5_good_data.csv")
...
# Save the CSV file
write.csv(datum, "../datasets/lecture_5_nonnormal_data.csv")
...
# Save the CSV file
write.csv(datum, "../datasets/lecture_5_nonlinear_data.csv")
...
# Save the CSV file
write.csv(datum, "../datasets/lecture_5_heteroscedastic_data.csv")
...
# Save the CSV file
write.csv(datum, "../datasets/lecture_5_autocorrelated_data.csv")
